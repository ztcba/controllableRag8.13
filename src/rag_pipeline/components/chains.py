...
# src/rag_pipeline/components/chains.py
...
from src.rag_pipeline.components import models
from src.rag_pipeline.components import prompts
...
def create_keep_only_relevant_content_chain():
    ...
    return prompt | llm.with_structured_output(models.KeepRelevantContent)
...
def create_question_answer_from_context_cot_chain():
    ...
    return prompt | llm.with_structured_output(models.QuestionAnswerFromContext)
...
def create_is_relevant_content_chain():
    ...
    return prompt | llm.with_structured_output(models.Relevance)
...
def create_can_be_answered_chain():
    ...
    return prompt | llm.with_structured_output(models.QuestionAnswer)
...
def create_is_distilled_content_grounded_on_content_chain():
    ...
    return prompt | llm.with_structured_output(models.IsDistilledContentGroundedOnContent)
...
def create_plan_chain():
    ...
    return prompt | planner_llm.with_structured_output(models.Plan)
...
def create_break_down_plan_chain():
    ...
    return prompt | llm.with_structured_output(models.Plan)
...
def create_replanner_chain():
    ...
    return prompt | replanner_llm.with_structured_output(models.Plan)
...
def create_task_handler_chain():
    ...
    return prompt | llm.with_structured_output(models.TaskHandlerOutput)
...
def create_deanonymize_plan_chain():
    ...
    return prompt | llm.with_structured_output(models.DeAnonymizePlan)
...
def create_can_be_answered_already_chain():
    ...
    return prompt | llm.with_structured_output(models.CanBeAnsweredAlready)